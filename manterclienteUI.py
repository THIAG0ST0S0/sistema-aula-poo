...
class ManterClienteUI:
  ...
  def atualizar():
    ...
    if len(clientes) == 0: st.write("Nenhum cliente cadastrado")
      ...
      op = st.selectbox("Atualização de Clientes", clientes, format_func=lambda x: x.get_nome())
  ...
  def excluir():
    ...
    if len(clientes) == 0: st.write("Nenhum cliente cadastrado")
      ...
      op = st.selectbox("Exclusão de Clientes", clientes, format_func=lambda x: x.get_nome())
